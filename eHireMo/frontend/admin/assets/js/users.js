$(document).ready(function() {
    ...
    function load_data(page, action) {
        ...
        if (action === "search") {
            ...
            $.ajax({
                url: "https://btech-ehiremo.000webhostapp.com/eHireMo/backend/api/users/admin_search_pending.php",
                method: "POST",
        ...
        xhttp.open(
            "POST",
            "https://btech-ehiremo.000webhostapp.com/eHireMo/backend/api/users/admin_fetch_all.php"
        );
    ...
    $(document).on('click', '.tr-user', function() {
        ...
        xhttp.open(
            "GET",
            "https://btech-ehiremo.000webhostapp.com/eHireMo/backend/api/users/admin_fetch_one.php?user_id=" + user_get_id
        );
        xhttp.send();
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
    ...
    $(document).on('click', '#yes-approve', function() {
        ...
        xhttp.open(
            "POST",
            "https://btech-ehiremo.000webhostapp.com/eHireMo/backend/api/users/admin_send_email.php"
        );
    ...
    $(document).on('click', '#yes-deny', function() {
        ...
        xhttp.open(
            "POST",
            "https://btech-ehiremo.000webhostapp.com/eHireMo/backend/api/users/admin_deny_email.php"
        );
        xhttp.send(JSON.stringify(send_email_data));
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 201) {
