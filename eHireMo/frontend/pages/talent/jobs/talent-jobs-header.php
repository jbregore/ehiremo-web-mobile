...
<div class="navbar">
    ...
    <div class="menuItemsRight">
        <ul>
            ...
            <span style="min-width: 0;position: absolute;top: -8px;right: -5px;padding: 2px 5px;border-radius: 50%;
...
<div id="mySidenav" class="sidenav">
    ...
    padding-left: 30px;padding-bottom: 20px;">
            <img alt="" id="mobile-profile-picture" src="../assets/images/people.png" width="52" style="border-radius:50%; width:52px;height:52px;object-fit:cover;" />
