    ...
    <div id="id02" class="modal" style="display: none;">
        <div class="modal-content">
            <div class="container">
                ...
                <p>Are you sure you want to remove this saved freelancer?</p>
                <div class="clearfix">
                    <button type="button" onclick="document.getElementById('id02').style.display='none'" class="cancelbtnn">Cancel</button>
                    <button type="button" onclick="document.getElementById('id02').style.display='none'" class="okaybtnn" id="remove-save">Remove</button>
                </div>
            </div>
        </div>
    </div>
