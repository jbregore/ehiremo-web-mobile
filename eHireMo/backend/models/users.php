...
class Users
{
    ...
    public function adminSendEmail()
    {
        ...
        For us to verify your email address, please click the link below.</p>
        ...
        please click this link: <a href='http://192.168.42.241/ehiremo/frontend/pages/talent/talent-welcome-page.php?vkey=$to_vkey'> Confirm your account </a></p>
    ...
    public function adminSendEmailClient()
    {
        ...
        <p>Verifying your e-mail address ensures that only you have access to your account information.</p>
        <p>To complete this verification 
        please click this link: <a href='http://192.168.42.241/ehiremo/frontend/pages/client/client-welcome-page.php?vkey=$to_vkey'> Confirm your account </a></p>
        <p>This is an auto generated email.DO NOT REPLY.</p>
        <p>-eHiremo</p>";
    ...
    public function adminDenyEmail()
    {
        ...
        <p>You may sign up again at <a href='http://192.168.42.241/ehiremo/frontend/sign-up-details.php'> eHiremo </a> 
        and submit a valid ID for verification. Make sure that the photo of the ID is
