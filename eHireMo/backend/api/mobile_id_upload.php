...
$upload_dir = 'http://192.168.42.241/ehiremo/backend/uploads/user_ids/';

$upload_url = 'http://192.168.42.241/ehiremo/backend/uploads/user_ids/';
...
if (isset($_POST['submit'])) {
    ...
    if ($is_image) {
        ...
        // $fileDest);
        $_SERVER["DOCUMENT_ROOT"]. "/ehiremo/backend/uploads/user_ids/". $fileNameNew);
