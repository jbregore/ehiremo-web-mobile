...
$upload_dir = 'http://192.168.42.241/ehiremo/backend/uploads/portfolios/';

$upload_url = 'http://192.168.42.241/ehiremo/backend/uploads/portfolios/';
...
if (isset($_POST['submit'])) {
    ...
    move_uploaded_file(
        $fileTmpName,
        // $fileDest);
        $_SERVER["DOCUMENT_ROOT"] . "/ehiremo/backend/uploads/portfolios/" . $fileNameNew
    );
