...
const Verification = ({ navigation }) => {
  ...
  const chooseWhole = async () => {
    ...
    if (!result.cancelled) {
      setWholeImage(result.uri);
      setWholeImageValue(result);
    }
  }
            ...
            <View style={{ ...styles.modalView }}>
              ...
              <View style={{ flexDirection: "column", }}>
                <Text style={{
                  ...
                  textAlign: 'center',
                  lineHeight: 25
                }}>Now upload a photo that you are holding this id</Text>

              </View>

              <View style={{
                width: '70%', height: 180, marginTop: 20,
                borderColor: "#ccc", borderWidth: 1
              }}>
                <Image
                  style={{ width: '100%', height: '100%' }}
                  // resizeMode="cover"
                  source={{ uri: wholeImage }}
                />
              </View>
