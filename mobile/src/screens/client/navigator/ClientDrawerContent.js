...
export function ClientDrawerContent({ navigation, props }) {
    ...
    const logout = () => {
        setIsLoading(true);
        fetch('http://192.168.42.241/ehiremo/backend/api/users/logout.php', {
            method: 'GET',
            headers: {
                //Header Defination
                'Accept': 'application/json',
                        ...
                        <View style={styles.drawerContent}>
                            <View style={styles.userInfoSection}>
                                ...
                                <View style={{ flexDirection: "row", marginTop: 5, marginBottom: 15 }}>
                                    ...
                                    <View style={{ marginLeft: 15, flexDirection: "column" }}>
                                        ...
                                        <Caption style={styles.caption}>Client</Caption>
                                    </View>
                                </View>
                            ...
                            <Drawer.Section style={styles.drawerSection}>
                                <DrawerItem
                                    ...
                                    label="My Profile"
                                    onPress={() => { navigation.navigate("ClientMyProfile") }}
                                />
                                ...
                                <DrawerItem
                                    ...
                                    label="Jobs"
                                    onPress={() => { navigation.navigate("ClientMyJobPost") }}
                                />
                                ...
                                <DrawerItem
                                    ...
                                    label="Messages"
                                    onPress={() => { navigation.navigate("ClientMessage") }}
                                />
                                ...
                                <DrawerItem
                                    ...
                                    label="Help"
                                    onPress={() => { navigation.navigate("ClientHelp") }}
                                />
