        ...
        <View style={{
          ...
          <View style={{ flexDirection: "column" }}>
            <Text style={styles.caption2}>
              ...
              >
                <Text style={{ color: "#14a800", textDecorationLine: 'underline', fontSize: 16, }}>
                  {item.client_name}
                </Text>
              </TouchableOpacity>
                ...
                return (
                  <View key={key}>
                    ...
                    <Pressable onPress={() => showImageFull(row.fb_photos)}>
                      <Image key={key} style={styles.wrap} resizeMode="cover" source={{ uri: row.fb_photos }} />
                    </Pressable>
                  </View>
                )
              } else {
                ...
                return (
                  <View key={index}>
                    <Text style={{
                      ...
                      Feedback from {
                        row.fb_from === item.profile_userid ? info.fname : item.client_fname
                      }{" "}:</Text>
