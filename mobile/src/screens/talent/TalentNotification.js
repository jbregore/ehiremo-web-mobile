...
const TalentNotification = ({ navigation }) => {
    ...
    const loadData = () => {
        fetch("http://192.168.42.241/ehiremo/backend/api/users/user_fetch_self.php", {
            ...
            .then((responseJson) => {
                ...
                fetch("http://192.168.42.241/ehiremo/backend/api/users/get_notif.php", {
                    method: "POST",
    ...
    useEffect(() => {
        ...
        for (let row of myNotification) {
            ...
            // CREATED AT
            fetch(
                "http://192.168.42.241/ehiremo/backend/api/jobs/get_time_created.php",
                {
                    method: "POST",
    ...
    const MyNotifComponent = myNotification.map((row, index) => (
        <View
            style={{
                height: 70,
                width: "100%",
