...
const CurrentJobs = ({ navigation }) => {
  ...
  const loadData = () => {
    ...
    fetch("http://192.168.42.241/ehiremo/backend/api/appointments/freelancer_fetch_my_appointments.php", {
      method: "POST",
    ...
    //JOB COUNT
    fetch('http://192.168.42.241/ehiremo/backend/api/users/freelancer_my_job_count.php', {
      method: 'GET',
      headers: {
        //Header Defination
        'Accept': 'application/json',
  ...
  const goCancel = () => {
    ...
    fetch(
      "http://192.168.42.241/ehiremo/backend/api/appointments/fcancel_appointment.php",
      {
        method: "PUT",
  ...
  const goSendFeedback = () => {
    ...
    fetch('http://192.168.42.241/ehiremo/backend/api/appointments/fmarkasdone_appointment.php', {
      method: 'PUT',
      ...
      <View style={styles.screen}>
        <ScrollView showsVerticalScrollIndicator={false} refreshControl={
          ...
          >
            ...
            >{freelancerCount} Current Jobs found.</Text>
          </View>
