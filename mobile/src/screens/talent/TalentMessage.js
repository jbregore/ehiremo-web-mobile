...
const TalentMessage = ({ navigation }) => {
  ...
  const loadChatsData = () => {
    ...
    fetch("http://192.168.42.241/ehiremo/backend/api/messages/fetch_chats.php", {
      method: "GET",
      headers: {
        //Header Defination
        Accept: "application/json",
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      for (let row of new_arr) {
        fetch("http://192.168.42.241/ehiremo/backend/api/messages/get_mesage_profile.php", {
          method: "POST",
        ...
        // fetch("http://192.168.42.241/ehiremo/backend/api/messages/get_created_at.php", {
        //   method: "POST",
        //   body: JSON.stringify({ id: row}),
        //   headers: {
        //     //Header Defination
  ...
  const viewChat = async (id) => {
    ...
    try {
      ...
      navigation.navigate("TalentChats");
    } catch (err) {
      console.log(err);
    }
  ...
  const searchNewChat = () => {
    ...
    fetch("http://192.168.42.241/ehiremo/backend/api/users/new_chat_message.php", {
      method: "POST",
  ...
  const searchPrevChat = () => {
    ...
    fetch("http://192.168.42.241/ehiremo/backend/api/users/get_name_message.php", {
      method: "POST",
