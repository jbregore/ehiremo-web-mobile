...
const SavedJobs = ({ navigation }) => {
  ...
  const loadData = () => {
    ...
    fetch('http://192.168.42.241/ehiremo/backend/api/jobs/my_saved_jobs.php', {
      method: 'POST',
    ...
    //JOBS COUNT
    fetch('http://192.168.42.241/ehiremo/backend/api/jobs/saved_job_post_count.php', {
      method: 'GET',
      headers: {
        //Header Defination
        'Accept': 'application/json',
      ...
      .then((responseJson) => {
        ...
        setSavedJobsCount(result.total_job_count.total_job_count);
      })
      .catch((error) => {
        //Hide Loader
        console.log(error)
  ...
  const removeJob = (id) => {
    fetch('http://192.168.42.241/ehiremo/backend/api/jobs/remove_saved_job.php', {
      method: 'DELETE',
      body: JSON.stringify({ job_post_id: id }),
      headers: {
        //Header Defination
  ...
  const SavedJobsComponent = jobsData.map((row) => (
    <View style={{
  ...
  const sigeSearch = () => {
    ...
    fetch("http://192.168.42.241/ehiremo/backend/api/jobs/search_my_saved_jobs.php", {
      method: "POST",
    ...
    fetch("http://192.168.42.241/ehiremo/backend/api/jobs/search_saved_job_post_count.php", {
      method: "POST",
      body: JSON.stringify(search_data),
      headers: {
        //Header Defination
      ...
      .then((responseJson) => {
        ...
        const result = JSON.parse(responseJson);
        // console.log(result);
        setSavedJobsCount(result.total_job_count)
      ...
      <View style={styles.screen}>
        ...
        >
          ...
          <View style={{
            ...
            <Text style={{ ...styles.caption, justifyContent: "flex-end" }}>{savedJobsCount} Saved Jobs.</Text>
          </View>
          ...
          {/* DINE */}
          {loadingInfo2 ? (<View></View>) : (<>{SavedJobsComponent}</>)}
